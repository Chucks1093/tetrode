				...
				return (
					<StepElement
						...
						className={cn(
							...
							isActive ? 'bg-odin-dark-1000' : 'bg-odin-dark-500',
							isClickable && [
								'cursor-pointer hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-odin-dark-700',
								!isActive && 'hover:bg-odin-dark-600',
							],
