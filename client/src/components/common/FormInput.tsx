...
export const FormInput: React.FC<FormInputProps> = ({
	...
	const baseInputStyles = `
		...
		focus:ring-0 h-14
		placeholder:text-odin-dark-1000-a-50 
		disabled:bg-odin-dark-300 disabled:cursor-not-allowed bg-odin-dark-200 text-odin-dark-1000 selection:bg-odin-dark-1000 selection:text-odin-dark-0 
		${
			hasError
				? 'border-red-500 focus:border-red-500 focus:ring-red-500'
				: 'border-odin-dark-500 focus:border-odin-dark-700'
		}
		${className}
	`;
	...
	const containerStyles = `
		...
		${
			hasError
				...
				: 'border-odin-dark-500 focus-within:ring-odin-dark-500/40 focus-within:ring-[3px]'
		}
		${disabled ? 'bg-odin-dark-300 cursor-not-allowed' : 'bg-odin-dark-200'}
		${wrapperClassName}
	`;
	...
	const renderInput = () => {
		const commonProps = {
			...
			className: cn(
				...
				'aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive placeholder:text-odin-dark-1000-a-50',
				baseInputStyles
			),
		};
	...
	return (
		<div className="space-y-2">
			<label
				htmlFor={inputId}
				className="block text-sm font-medium text-odin-dark-1000-a-65"
			>
				{label}
